        ...
        <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <input class="form-control" type="number" name="harga" id="harga" value="">
            ...
            <div class="row">
                ...
                <div class="form-group mx-2 col-sm-5 ">
                    ...
                    <input class="form-control" type="number" name="stok" id="stok" value="">
                    <div class="invalid-feedback">Example invalid custom select feedback</div>
                </div>
            </div>
            <div class="row">
            ...
            <div class=" text-center my-3">
                ...
                <a href="../admin/produk.php" class="btn btn-sm btn-danger w-25" class="card-link">Batal</a>
            </div>
        </form>
    </div>
</div>
