...
<div class="row py-3 px-3 bg-light">
    ...
    <div class="col-md d-flex justify-content-end">
        ...
        <a href="../admin/cetakTransaksi.php" class="text-decoration-none text-dark d-flex"><i class="fa fa-download mr-2"></i>
            <h6> Cetak PDF</h6>
        </a>
    </div>
</div>
            ...
            <tr>
                ...
                <td>
                    <?php
                        ...
                        $pesanAt = date_create($value->pesan_at);
                        $pesanAt->add(new DateInterval('PT18H'));
                        $pesanAt = date_format($pesanAt, 'd-m-Y H:i:s')
                    ?>
                    <?= $pesanAt ?>
                </td>
