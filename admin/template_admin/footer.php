        ...
        <div class="modal fade" id="cek-bayar<?= $value->id_pesan ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <?php
                    list($cek, $transaksi) = cekBayar($value->id_pesan);
                    ?>
                    ...
                    <form method="POST" action="">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?= $transaksi->penerima ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="telepon">Nomor Telepon Penerima</label>
                                <input class="form-control" type="text" value="<?= $transaksi->telepon ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input class="form-control" type="text" value="<?= $transaksi->alamat ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="pengirim">Nama Pengirim</label>
                                <input class="form-control" type="text" name="pengirim" value="">
                            </div>
                            <div class="form-group text-center">
                                <img src="../assets/images/bayar/<?= $cek->gambar ?>" class="  w-50" alt="">
                            </div>
                        </div>
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                foreach ($trDetail as $key => $detail) : ?>
                                    <tr class="border-bottom">
                                        ...
                                        <td><img src="../assets/images/produk/<?= $detail->gambar ?>" class="w-100" alt=""></td>
                                        <td><?= $detail->nama ?></td>
                            ...
                            <tfoot>
                                <tr>
                                    <td class="text-uppercase">Ongkir : <?= number_format($value->ongkir, 0) ?></td>
                                </tr>
                                <tr>
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-header">
                                <img src="../assets/images/user/<?= $value->image ?>" alt="">
                            </div>
