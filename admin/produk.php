...
<div class="produk my-2 py-2 bg-primary text-light ">
    ...
    <div class="judul my-3 mx-5 text-uppercase d-flex justify-content-between">
        <h5>Produk</h5>
        <a href="../admin/tambahProduk.php" class="btn btn-sm btn-light mr-4">Tambah Produk</a>
    </div>
    <ul class="list-group text-dark">
        <?php foreach ($produk as $key => $value) : ?>
            <li class="list-group-item d-flex">
                <strong class=""><?= $key + 1 . "." ?></strong>
                <span class="col"><a href="../admin/detailproduk.php?id=<?= $value->id_produk ?>" class="text-decoration-none" style="cursor: pointer"><?= $value->nama ?></a></span>
        ...
        <tbody>
            <?php foreach ($produk as $key => $value) : ?>
                <tr>
                    ...
                    <td>
                        <img src="<?= '../assets/images/produk/' . $value->gambar ?>" style="width: 80px" alt="">
                    </td>
                    <td><?= $value->nama ?></td>
                    ...
                    <td class="text-center px-0 ">
                        <div class="d-flex justify-content-center align-items-center">
                            <a href="../admin/detailproduk.php?id=<?= $value->id_produk ?>" class="btn btn-sm btn-info">Detail</a>
                            <form action="../admin/produk.php?id=<?= $value->id_produk ?>" method="POST">
