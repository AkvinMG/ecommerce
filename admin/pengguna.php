...
<div class="row py-3 px-3 bg-light justify-content-around">
    ...
    <div class="col-sm">
        <a href="../admin/cetakPengguna.php" class="d-flex justify-content-end text-decoration-none"><i class=" fa fa-download"></i>
    ...
    <tbody>
        <?php foreach ($pengguna as $key => $value) : ?>
            <tr>
                ...
                <td><?= $value->id_user ?></td>
                <td>
                    <img src="../assets/images/user/<?= $value->image ?>" class="w-75 bg-light" alt="">
                </td>
                <td><?= $value->nama ?></td>
                <td><?= $value->email ?></td>
                <td>
