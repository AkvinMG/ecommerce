...
<div class="heading text-center bg-light mt-2 p-3 ">
    <div class="row text-left ">
        ...
        <div class="col-4 border-right">
            ...
            <p>Rp <?= number_format(home()['totalAkhir']->total_akhir, 0) ?> </p>
        </div>
        <div class="col-4">
            <h5>TOTAL PENJUALAN BULAN INI</h5>
            <p>Rp <?= number_format(home()['totalAkhirThisMonth']->total_akhir, 0) ?> </p>
        </div>
    </div>
</div>
...
<table class="transaksi table mt-3">
    ...
    <tfoot>
        <tr>
            <td>
                <a class="text-decoration-none" href="../admin/transaksi.php"> Lihat lainnya &raquo;</a>
            </td>
        </tr>
    </tfoot>
</table>
