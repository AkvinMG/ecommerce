...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../assets/images/pages/beranda1.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../assets/images/pages/beranda2.png" class="d-block w-100" alt="...">
        </div>
    </div>
</div>
        ...
        <?php foreach ($produk as $value) : ?>
            <div class="col-md-2 card-produk shadow-sm m-1  bg-white">
                <div class="card-img" style=" height:50%;">
                    <img src="../assets/images/produk/<?= $value->gambar ?>" class="img-fluid " style="width: 100%;" alt="...">
                </div>
                ...
                <div class="d-flex justify-content-around p-2 w-75 border-top m-auto">
                    <a href="../user/detail.php?id=<?= $value->id_produk ?>" class="btn btn-sm btn-info mr-1 ">Detail</a>
...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-50">
            <img class="w-50" src="../assets/images/pages/promo1.png" alt="">
            <img class="w-50" src="../assets/images/pages/promo2.png" alt="">
            <img class="w-50" src="../assets/images/pages/promo3.png" alt="">
            <img class="w-50" src="../assets/images/pages/promo4.png" alt="">
        </div>
    </div>
</div>
